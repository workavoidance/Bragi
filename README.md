...
1. [Download the Skrivi v0.2 alpha installer for Windows 11](https://github.com/workavoidance/Skrivi/releases/download/v0.2.0-alpha.2/Skrivi-v0.2.0-alpha.2-windows-x64-setup.exe).
...
ZIP from the [release page](https://github.com/workavoidance/Skrivi/releases/tag/v0.2.0-alpha.2)
